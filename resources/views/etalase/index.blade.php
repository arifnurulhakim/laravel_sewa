        ...
        @foreach($barang as $key => $item)
            <div class="col-md-3">
                <div class="card" style="width: 18rem;">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                            ...
                            @csrf
                                ...
                                <input type="hidden" name="jenis_transaksi" id="jenis_transaksi_input" value="">
                    ...
                    <div class="card-body">
                    <center>
        <button type="submit" class="btn btn-success mt-2" onclick="setJenisTransaksi('sewa')">sewa</button>
    </center>
    <center>
        <button type="submit" class="btn btn-warning mt-2" onclick="setJenisTransaksi('beli')">beli</button>
    </center>
    </div>
                    </form>
                </div>
...
$(document).ready(function() {
    ...
    $('.input-number').keydown(function(e) {
        ...
        document.getElementById('jenis_transaksi_input').value = jenis;
    }
    </script>
@endpush
