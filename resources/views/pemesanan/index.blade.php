                        ...
                        <tbody>
                            @foreach($kode_pemesanan as $key => $item)
                                <tr>
                                    ...
                                    <td>
                                        @if($item->status == 'dikonfirmasi' && $item->kode_pemesanan)

                                        <div type="button" class="btn btn-warning btn-xs btn-detail" data-id="{{  ['kode_pemesanan' => $item->kode_pemesanan] }}" data-toggle="modal" data-target="#detailPemesanan">
                                        detail
                                    </div>
                                        ...
                                        <a href="{{ route('pemesanan.sewakan', $item->kode_pemesanan) }}" class="btn btn-success btn-xs">
                                            ...
                                            <a ef="{{route('pemesanan.destroy',$item->kode_pemesanan)}}"  onclick="notificationBeforeDelete(event, this)" class="btn btn-danger btn-xs">
                                                Delete
                                            </a>
