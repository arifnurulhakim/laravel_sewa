...
@section('content_header')
    <h1 class="m-0 text-dark">List Proses Pesanan</h1>
@stop
                        ...
                        <tbody>
                            @foreach($kode_pemesanan as $key => $item)
                                <tr>
                                    ...
                                    {{--<td>$item->alamat</td>--}}
                                    <td>
                                        @if($item->status != 'sedang di proses')
                                        <a href="{{ route('pemesanan.proses', $item->kode_pemesanan) }}" class="btn btn-success btn-xs">
                                                Proses
                                            </a>
